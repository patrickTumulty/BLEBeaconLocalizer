...
{
    uWS::App::WebSocketBehavior<PerSocketData> config =
        (uWS::App::WebSocketBehavior<PerSocketData>) {
            ...
            .close = [](auto *ws, int code, std::string_view message) {
                ...
                websockets.erase(std::remove_if(websockets.begin(),
                                                websockets.end(), predicate));
            },
        };
    ...
    app.listen(9000, [](auto *listenSocket) {
        if (listenSocket)
        {
